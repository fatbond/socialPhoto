...
- (MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id < MKAnnotation >)annotation
{
    ...
    if([annotation isKindOfClass:[ImagePin class]]){
        ImagePinView *annView = (ImagePinView *)[mapView dequeueReusableAnnotationViewWithIdentifier:ImagePinID];
        if (annView == nil)
            annView = [[ImagePinView alloc] initWithAnnotation:annotation reuseIdentifier:ImagePinID];
    ...
    if([view.annotation isKindOfClass:[ImagePin class]]){        
        ...
        for(ImagePin *ann in self.myMap.annotations)
            if([ann isKindOfClass:[ImagePin class]]){
                ImagePinView *annView = (ImagePinView*)[self mapView:self.myMap viewForAnnotation:ann];
        ...
        if([listImageToShow count] == 1)
        {
            ...
            ((UIImageView*)[((ImagePinView*)view).subviews objectAtIndex:0]).frame = CGRectMake(0, -30, 72, 72);
            ((UIImageView*)[((ImagePinView*)view).subviews objectAtIndex:1]).frame = CGRectMake(7, -27, 52, 52);
        }
        else
        {
...
- (void)mapView:(MKMapView *)mapView didDeselectAnnotationView:(MKAnnotationView *)view
{
    ...
    if([view.annotation isKindOfClass:[ImagePin class]]){
        ...
        ((UIImageView*)[((ImagePinView*)view).subviews objectAtIndex:0]).frame = CGRectMake(0, -28, 56, 56);
        ((UIImageView*)[((ImagePinView*)view).subviews objectAtIndex:1]).frame = CGRectMake(7, -23, 38, 38);
    }
}
...
{
    return [((ImagePin*)((ImagePinView*)[listImageToShow objectAtIndex:index]).annotation) getURL];
}
